...
class TransformKeyFrames:
    ...
    def value(self, time):
        ...
        r = quaternion_matrix(quaternion(self.rotate_keys.value(time)))
...
def main():
    ...
    # model = (*[m for file in sys.argv[1:] for m in load_skinned(file)])
    ...
    # keynode.add(*[m for file in sys.argv[1:] for m in load_skinned(file)])
    keynode.add(SkinnedCylinder())
    # print(keynode.keyframes.value(2.5))
    # print(keynode.keyframes.value(7.1))
    # print(keynode.keyframes.value(10.1))
    viewer.add(keynode)
