...
void main() {
    vec3 c = vec3(1) * dot(fragNormal, light);
...
class ColorMesh:
    ...
    def draw(self, projection, view, model, light, color_shader):

        names = ['view', 'projection', 'model', 'light']
        ...
        GL.glUniform3fv(loc['light'], 1, light)
        # print(light)
...
class Viewer:
    ...
    def run(self):
        ...
        while not glfw.window_should_close(self.win):
            ...
            light = (2 * math.sin(time), 0, 2 * math.cos(time))            
            
            # draw our scene objects
            for drawable in self.drawables:
                drawable.draw(projection, view, identity(), light,
